                        ...
                        @foreach ($moduls as $modul)
                            <div class="col-xl-4 col-md-6  portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <article>
                                      <a href="{{route('modul_detail', $modul->modul_id)}}" data-gallery="portfolio-gallery-app"
                                        class="glightbox"><img src="document/fotoStorage/{{$modul->foto}}" class="img-fluid"
                                            alt="" style="height: 15em; width: 20em;"></a>
                                    <div class="portfolio-info">
                                        <h4 style="word-break: break-all"><a href="portfolio-details.html" title="More Details">{{ Str::limit($modul->name, 15, ' . . .') }}</a></h4>
                                        <p style="word-break: break-all">{{ Str::limit($modul->content, 30, ' . . .') }}</p>
                                    </div>
                                    </article>
                                </div>
